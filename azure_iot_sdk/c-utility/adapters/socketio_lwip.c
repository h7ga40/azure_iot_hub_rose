...
static void* socketio_lwip_CloneOption(const char* name, const void* value)
{
    void* result;
...
static void socketio_lwip_DestroyOption(const char* name, const void* value)
{
    if (name != NULL)
    {
...
CONCRETE_IO_HANDLE socketio_lwip_create(void* io_create_parameters);
void socketio_lwip_destroy(CONCRETE_IO_HANDLE socket_io);
int socketio_lwip_open(CONCRETE_IO_HANDLE socket_io, ON_IO_OPEN_COMPLETE on_io_open_complete, void* on_io_open_complete_context, ON_BYTES_RECEIVED on_bytes_received, void* on_bytes_received_context, ON_IO_ERROR on_io_error, void* on_io_error_context);
int socketio_lwip_close(CONCRETE_IO_HANDLE socket_io, ON_IO_CLOSE_COMPLETE on_io_close_complete, void* callback_context);
int socketio_lwip_send(CONCRETE_IO_HANDLE socket_io, const void* buffer, size_t size, ON_SEND_COMPLETE on_send_complete, void* callback_context);
void socketio_lwip_dowork(CONCRETE_IO_HANDLE socket_io);
int socketio_lwip_setoption(CONCRETE_IO_HANDLE socket_io, const char* optionName, const void* value);

static OPTIONHANDLER_HANDLE socketio_lwip_retrieveoptions(CONCRETE_IO_HANDLE handle)
{
    ...
    else
    {
        ...
        result = OptionHandler_Create(socketio_lwip_CloneOption, socketio_lwip_DestroyOption, socketio_lwip_setoption);
        if (result == NULL)
        {
...
{
    socketio_lwip_retrieveoptions,
    socketio_lwip_create,
    socketio_lwip_destroy,
    socketio_lwip_open,
    socketio_lwip_close,
    socketio_lwip_send,
    socketio_lwip_dowork,
...
static int socketio_lwip_setaddresstype_option(SOCKET_IO_INSTANCE* socket_io_instance, const char* addressType)
{
    int result;
...
int socketio_lwip_setoption(CONCRETE_IO_HANDLE socket_io, const char* optionName, const void* value)
{
    ...
    else
    {
        ...
        {
            result = socketio_lwip_setaddresstype_option(socket_io_instance, (const char*)value);
        }
        else
        {
            result = MU_FAILURE;
...
const IO_INTERFACE_DESCRIPTION* socketio_lwip_get_interface_description(void)
{
