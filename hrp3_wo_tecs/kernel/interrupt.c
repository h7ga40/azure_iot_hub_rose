...
dis_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2);			/*［NGKI3084］*/
...
ena_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2);			/*［NGKI3097］*/
...
clr_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2);			/*［NGKI3922］*/
...
ras_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2);			/*［NGKI3934］*/
...
prb_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn4);			/*［NGKI3946］*/
...
get_ipm(PRI *p_intpri)
{
	...
	CHECK_MACV_WRITE(p_intpri, PRI);			/*［NGKI3119］*/
	CHECK_ACPTN(sysstat_acvct.acptn4);			/*［NGKI3118］*/
