...
set_tim(SYSTIM systim)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn3);			/*［NGKI3566］*/
...
get_tim(SYSTIM *p_systim)
{
	...
	CHECK_MACV_WRITE(p_systim, SYSTIM);			/*［NGKI2353］*/
	CHECK_ACPTN(sysstat_acvct.acptn4);			/*［NGKI2352］*/
...
adj_tim(int32_t adjtim)
{
	...
	CHECK_PAR(TMIN_ADJTIM <= adjtim && adjtim <= TMAX_ADJTIM);
												/*［NGKI3584］*/
	CHECK_ACPTN(sysstat_acvct.acptn3);			/*［NGKI3585］*/
