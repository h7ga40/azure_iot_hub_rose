 ...
 */
ER_UINT
extsvc_init_hist(intptr_t histid, intptr_t par2, intptr_t par3,
							intptr_t par4, intptr_t par5, ID cdmid)
{
	return((ER_UINT) _init_hist((ID) histid));
}

ER_UINT
extsvc_begin_measure(intptr_t histid, intptr_t par2, intptr_t par3,
							intptr_t par4, intptr_t par5, ID cdmid)
{
	return((ER_UINT) _begin_measure((ID) histid));
}

ER_UINT
extsvc_end_measure(intptr_t histid, intptr_t buf, intptr_t len,
							intptr_t par4, intptr_t par5, ID cdmid)
{
	return((ER_UINT) _end_measure((ID) histid));
}

ER_UINT
extsvc_print_hist(intptr_t histid, intptr_t buf, intptr_t len,
							intptr_t par4, intptr_t par5, ID cdmid)
{
	return((ER_UINT) _print_hist((ID) histid));
}
